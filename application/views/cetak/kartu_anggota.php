...
<table width="100%">
<tr>
<td style="width: 18mm"><img src="<?=base_URL()?>asset1/img/<?=$q_perpus->logo?>" style="width: 50px; height: 50px"></td>
<td style="" colspan="3"><b style="font-size: 12px"><?=strtoupper($q_perpus->nama)?></b><br><span style="font-size: 10px">Alamat : <?=$q_perpus->alamat?></span></td>
</tr>
<tr><td colspan="4" style="text-align: center"><hr></td></tr>
<tr><td colspan="4" style="text-align: center"><b style="font-size: 14px"><u><br>KARTU ANGGOTA</u></b><br>Nomor : <?=$d->id_anggota?><br><br><br></td></tr>

<tr><td rowspan="5"><img src="" style="width: 60px; height: 80px"></td><td>Nama</td><td>:</td><td> <b><?=$d->nama?></b></td></tr>
<tr><td>Kelas</td><td>:</td><td><b><?=$d->kelas?></b></td></tr>
<tr><td>J K</td><td>:</td><td><b><?=$d->jk?></b></td></tr>
<tr><td>Alamat</td><td>:</td><td><b><?=substr($d->alamat, 0, 50)?></b></td></tr>
<tr><td>T T L</td><td>:</td><td><b><?=$d->tmpt_lahir.", ".$d->tgl_lahir?></b></td></tr>
